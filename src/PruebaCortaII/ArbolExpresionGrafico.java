...
/**
 * Dibuja con las medidas adecuadas el arbol binario de busqueda
...
public class ArbolExpresionGrafico extends JPanel 
{
    ...
    /**
     * Constructor de la Clase ArbolExpresionGrafico.El constructor permite inicializar los atributos de la Clase ArbolExpresionGrafico
     * y llama al método repaint(), que es el encargado de pintar el Arbol.
     * @param miArbol: dato de tipo ArbolBB, arbol binario de busqueda
     */
     ...
     * los rectángulos representatives del árbol de la expresión.
     */
     ...
     * referencia para calcular el tamaño de cada subárbol.
     ...
     * @param n: Objeto de la clase Nodo que se utiliza como referencia para dibujar el árbol.
